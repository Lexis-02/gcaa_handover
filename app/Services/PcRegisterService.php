...
class PcRegisterService
{
    ...
    public function serializeForList(PcAsset $asset): array
    {
        ...
        return [
            ...
            'acc_power_adapter' => $asset->acc_power_adapter,
            'acc_carrying_bag' => $asset->acc_carrying_bag,
            'acc_hdmi_vga' => $asset->acc_hdmi_vga,
            'acc_mouse' => $asset->acc_mouse,
            'acc_docking_station' => $asset->acc_docking_station,
            'acc_headset' => $asset->acc_headset,
            'acc_keyboard' => $asset->acc_keyboard,
            'acc_monitor' => $asset->acc_monitor,
            'acc_other' => $asset->acc_other,
